...
interface Sofia3DAvatarProps {
  isHovered?: boolean
}

export default function Sofia3DAvatar({ isHovered = false }: Sofia3DAvatarProps) {
  return (
    <div className="w-full h-full flex items-center justify-center">
      ...
      <svg width="100%" height="100%" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
        {/* Cara */}
        <circle cx="100" cy="100" r="70" fill="#f0c8a0"/>

        {/* Pelo */}
        <path id="pelo-azul" d="M60 55 C40 25 60 10 100 10 C140 10 160 25 140 55 L120 85 H80 L60 55 Z" fill="#8B4513"/>
